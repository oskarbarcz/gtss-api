 ...
 *
 * @method null|Line find($id, $lockMode = null, $lockVersion = null)
 * @method null|Line findOneBy(array $criteria, array $orderBy = null)
 * @method Line[]    findAll()
...
class LineRepository extends ServiceEntityRepository
{
    ...
    public function save(Line $entity, bool $flush = false): void
    {
